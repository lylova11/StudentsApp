...
class CheckSortByAge : TestCase() {
    ...
    fun checkSortByAgeTest() = run {
        ...
        with(FavouritePersonsScreen(this)) {
            ...
            tapOnFilter().selectSortByAge()
            checkPersonOnPositionByName(0, "Christensen")
            checkPersonOnPositionByName(1, "Korhonen")
            checkPersonOnPositionByName(2, "Thompson")
        }
    }
}